...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div class="main-content-wrapper">
            <div>
                <img src="images/userl.png" width="170px;" height="300px;" style="float: left;margin-top: 20px;margin-left: 20px" />
            </div>
                    ...
                    <form action="laction.jsp" method="post">
                        <ul class="login">
                            ...
                            <li>
                                ...
                                <div class="forgot-pwd"><a href="ureg.jsp" style="text-decoration: none">New User</a></div>
